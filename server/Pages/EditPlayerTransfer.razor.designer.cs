...
{
    public partial class EditPlayerTransferComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Form0Submit(SoccerLeagueTransferApp.Models.ConData.PlayerTransfer args)
        {
            ...
            {
                    NotificationService.Notify(NotificationSeverity.Error, $"Error", $"Unable to update PlayerTransfer");
            }
        }
